...
.content p span {
  text-decoration: line-through;
        ...
        <div class="content">
            ...
            <p>We know it’s scary, but the page you’re trying to reach can’t be found. Perhaps it was just a bad <span>link</span> dream? <a style="color:#d1e2ed" href="{{ url('/') }}">Go Back Home!</a></p>
